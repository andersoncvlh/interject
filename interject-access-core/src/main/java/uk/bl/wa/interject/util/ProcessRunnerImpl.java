package uk.bl.wa.interject.util;
 ...
 * to ensure that they don't block.
 ...
 * </p>
 * 
 * Use the Assessor methods to configure the Environment, input, collecting
 * behaviour, timeout and startingDir. Use the getters to get the output and
